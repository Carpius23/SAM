...
export const PasswordInput = ({ label, value, onChange, placeholder, error, className }: PasswordInputProps) => {
        ...
        <div className={`grid w-full items-center gap-2 relative ${className}`}>
            ...
            <div className='relative'>
                <Input
                    ...
                    className='w-full h-11 pr-10' // pr-10 deja espacio para el botón
                />
                <button
